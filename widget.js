/* Popout widget mirrors logic from main app (read-only) */
...
const SKEY_PREFS='bb.prefs.v3_1', SKEY_USE_TEMPLATE='bb.useTemplateByDay.v1';
...
function blocksForToday(){
  ...
  return mergedTemplateBlocks(isFri);
}
